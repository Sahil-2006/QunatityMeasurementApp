...
public class Quantity<U extends IMeasurable> {
    ...
    public boolean equals(Object o) {
        ...
        if (this.unit.getClass() != that.unit.getClass()) return false; // Prevent cross-category comparison
        return Double.compare(this.unit.convertToBaseUnit(this.value), 
                             that.unit.convertToBaseUnit((Double)that.value)) == 0; // Simplified for brevity
    }
